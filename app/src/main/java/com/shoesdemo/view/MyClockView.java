...
public class MyClockView extends RelativeLayout  {
    ...
    private RelativeLayout.LayoutParams dayLayoutParams, hourLayoutParams, minLayoutParams,
            secLayoutParams;
    ...
    public void initView(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams dLayoutParams = new RelativeLayout.LayoutParams(
        ...
        hourLayoutParams = new RelativeLayout.LayoutParams(viewWidth,
                viewWidth);
        ...
        RelativeLayout.LayoutParams hLayoutParams = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        minLayoutParams = new RelativeLayout.LayoutParams(viewWidth,
                viewWidth);
        ...
        secLayoutParams = new RelativeLayout.LayoutParams(viewWidth,
                viewWidth);
        ...
        RelativeLayout.LayoutParams sLayoutParams = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
